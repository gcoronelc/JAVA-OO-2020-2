...
public class AlumnoView extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
			...
			//Variables
			int n1, n2, n3, n4, n5;
			PromedioDto dto; // Define la variable DTO
			//Datos
			...
			dto = new PromedioDto(); // Crea el objeto DTO
			dto.setNota1(n1);
			dto.setNota2(n2);
			dto.setNota3(n3);
			dto.setNota4(n4);
			...
			txtRepoMenor.setText("" + dto.getMenorNota());
			txtRepoPromedio.setText("" + dto.getPromedio());
			txtRepoCondicion.setText("" + dto.getCondicion());
